...
void process(YunClient client) {
  ...
  client.println("<a href='http://192.168.1.120/arduino/on^^'>Turn OFF LED 3</a><br>");
  client.println("<a href='http://192.168.1.120/arduino/off^^'>Turn ON LED 3</a><br>");
  client.println("<a href='http://192.168.1.120/arduino/on10^^'>Flash LEDs</a><br>");
  client.println("<a href='http://192.168.1.120/arduino/step^^'>Step Sequence</a><br>");
  client.println("<a href='http://192.168.1.120/arduino/back^^'>Reverse Step Sequence</a><br>");
