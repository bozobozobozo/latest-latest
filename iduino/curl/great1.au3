...
GUICtrlSetResizing(-1, $GUI_DOCKTOP + $GUI_DOCKLEFT + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
Local $hButton1 = GUICtrlCreateButton("on10 seq", 200, 33, 75, 25)
Local $hButton2 = GUICtrlCreateButton("13 off", 200, 63, 75, 25)
Local $hButton3 = GUICtrlCreateButton("13 on", 200, 93, 75, 25)
GUICtrlSetResizing(-1, $GUI_DOCKTOP + $GUI_DOCKLEFT + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
...
; BJS
$out = cURL_easy("http://192.168.1.107/arduino/on10^^", "cookie.txt", 2)
; output the HTTP response to the console
ConsoleWrite($out)
Case $hButton2
MsgBox(32, "qqqqqqqqq", "You have " & GUICtrlRead($hInput1) & "?")
; BJS
$out = cURL_easy("http://192.168.1.107/arduino/off^^", "cookie.txt", 2)
; output the HTTP response to the console
ConsoleWrite($out)
Case $hButton3
MsgBox(32, "33333333333", "You have " & GUICtrlRead($hInput1) & "?")
; BJS
$out = cURL_easy("http://192.168.1.107/arduino/on^^", "cookie.txt", 2)
; output the HTTP response to the console
ConsoleWrite($out)
EndSwitch
Case $aPanel[4]
